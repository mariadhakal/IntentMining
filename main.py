...
def main():
    ...
    parser.add_argument('--initial-distance', type=float, default=0.4, help='Initial distance parameter')
    parser.add_argument('--initial-min-samples', type=int, default=20, help='Initial minimum samples parameter')
    parser.add_argument('--delta-distance', type=float, default=0.03, help='Distance change per iteration')
